...
type TabName = "Permintaan Penawaran" | "Pengadaan Aktif" | "Implementasi" | "Pembayaran" | "Konfirmasi Selesai" | "Riwayat";

const tabs: TabName[] = ["Permintaan Penawaran", "Pengadaan Aktif", "Implementasi", "Pembayaran", "Konfirmasi Selesai", "Riwayat"];
      ...
      default:
        return (
          <div className="py-24 text-center text-gray-400">
            <p className="text-lg font-medium">Konten {activeTab} Belum Tersedia</p>
          </div>
        );
    }
  };
    ...
    <div className="bg-gray-50 p-6 font-sans">
      <div className="mx-auto">
        ...
        <p className="text-sm text-gray-500 mb-8 ml-12">
          Kelola dan pantau progres pengadaan barang dari seluruh daftar penawaran yang diajukan dan aktif.
        </p>
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`px-4 py-3 text-sm font-semibold whitespace-nowrap transition-all border-b-2 -mb-[2px] ${
                activeTab === tab ? "border-cyan-500 text-cyan-500" : "border-transparent text-gray-400 hover:text-gray-600"
              }`}
            >
              {tab}
            </button>
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="p-4 flex items-center justify-between border-t border-gray-100 text-[11px] text-gray-400">
            <p>Menampilkan <span className="font-bold text-gray-700">6</span> dari <span className="font-bold text-gray-700">42</span> data</p>
            <div className="flex items-center gap-1">
              <button className="p-1"><ChevronLeft size={16} /></button>
              <button className="w-7 h-7 rounded bg-cyan-500 text-white font-bold">1</button>
