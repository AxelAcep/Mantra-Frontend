...
export default function CardPenawaranPengadaan() {
    return (
        <Card className="rounded-xl border-slate-200 shadow-sm p-0 gap-0">
            ...
            <div className="flex justify-between items-center">
                ...
                <img 
                src={Icons.PenawaranPengadaan} 
                alt="Penawaran Pengadaan" 
            ...
            <p className="text-[12px] text-slate-500 mt-1">Penawaran Pengadaan</p>
            </CardContent>
        </Card>
    );
}