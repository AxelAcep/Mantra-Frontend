...
export default function CardRequestPenawaran() {
    return (
        <Card className="rounded-xl border-slate-200 shadow-sm p-0 gap-0">
            ...
            <div className="flex justify-between items-center">
                ...
                <img 
                src={Icons.RequestPenawaran} 
                alt="Request Penawaran" 
            ...
            <p className="text-[12px] text-slate-500 mt-1">Request Penawaran</p>
            </CardContent>
        </Card>
    );
}