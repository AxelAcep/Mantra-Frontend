            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-50 hover:bg-slate-50">
                  ...
                  <SortableHeader label="PERUSAHAAN" field="perusahaanName" sortBy={sortBy} sortDir={sortDir} onSort={handleSort} className="w-[15%]" />
                  <SortableHeader label="LOKASI" field="lokasiProyek" sortBy={sortBy} sortDir={sortDir} onSort={handleSort} className="w-[12%]" />
                  <TableHead className="h-11 w-[13%]">
                    <div className="flex items-center gap-1.5 text-[10px] font-bold text-slate-500 uppercase">JENIS BARANG</div>
                  </TableHead>
