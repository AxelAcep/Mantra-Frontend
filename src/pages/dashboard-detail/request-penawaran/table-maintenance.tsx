...
const permintaanData = [
  ...
  },
  {
    ...
    jenisBarang: "Inspeksi Fire Safety",
  },
  {
    tanggal: "21 Okt 2023",
    ...
    lokasi: "Medan",
    jenisBarang: "Perbaikan HVAC",
  },
];

export default function DaftarPermintaanPenawaranMaintenance() {
  return (
