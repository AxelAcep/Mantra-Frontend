...
import DaftarPermintaanPenawaranMaintenance from "./table-maintenance";

export default function TabsTableRequestPenawaran() {
    return (
        <Tabs defaultValue="pengadaan-barang">
            ...
            <TabsContent value="maintenance" className="pt-4">
                <DaftarPermintaanPenawaranMaintenance />
            </TabsContent>
        </Tabs>
    );
}