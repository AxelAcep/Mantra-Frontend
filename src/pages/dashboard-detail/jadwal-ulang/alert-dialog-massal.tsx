...
export function AlertDialogMassal({ children, onConfirm }: AlertDialogMassalProps) {
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="rounded-xl sm:max-w-[425px]">
        <AlertDialogHeader>
          <AlertDialogTitle className="text-slate-800 text-lg">
            Konfirmasi Penyelesaian Massal
          </AlertDialogTitle>
          <AlertDialogDescription className="text-slate-500 mt-2 text-sm leading-relaxed">
            Apakah Anda yakin ingin mengonfirmasi bahwa seluruh <strong>Pengajuan Reschedule</strong> dalam daftar ini telah selesai?
          </AlertDialogDescription>
        </AlertDialogHeader>
