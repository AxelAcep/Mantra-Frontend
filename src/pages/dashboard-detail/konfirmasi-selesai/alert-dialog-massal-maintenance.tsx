      ...
      <AlertDialogContent className="rounded-xl sm:max-w-[425px]">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-slate-500 mt-2 text-sm leading-relaxed">
            Apakah Anda yakin ingin mengonfirmasi bahwa seluruh proyek <strong>Maintenance</strong> dalam daftar ini telah selesai? Tindakan ini akan memperbarui status proyek menjadi selesai secara otomatis.
          </AlertDialogDescription>
        </AlertDialogHeader>
