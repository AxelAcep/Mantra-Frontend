...
const dummyPengadaanProgressData = [
  {
...
const pengadaanProgressData: typeof dummyPengadaanProgressData = [];
    ...
    <Card className="rounded-xl border-slate-200 shadow-sm overflow-hidden py-0! gap-0!">
      ...
      <CardContent className="p-0">
        <Table>
          ...
          <TableBody>
            {pengadaanProgressData.length === 0 ? (
              <TableRow>
      ...
      <div className="flex justify-between items-center p-4 border-t border-slate-100 bg-white">
        <p className="text-xs text-slate-500">
          Menampilkan <strong className="text-slate-700">{pengadaanProgressData.length}</strong> dari <strong className="text-slate-700">{pengadaanProgressData.length}</strong> data
        </p>
        ...
        <div className="flex items-center gap-1">
          ...
          <Button variant="ghost" size="icon" className="w-7 h-7 rounded-md text-slate-600 hover:bg-slate-100" disabled={pengadaanProgressData.length === 0}>
