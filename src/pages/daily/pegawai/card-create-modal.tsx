                            ...
                            <Popover open={openPerusahaan} onOpenChange={setOpenPerusahaan}>
                                <PopoverTrigger asChild>
                                    <Button
                                        ...
                                        disabled={hasOverdue}
                                        className={cn(
                                            "w-full justify-between bg-slate-50 border-gray-200 text-gray-700 px-3 h-10 font-normal hover:bg-slate-50/80 focus:ring-cyan-600 focus:border-cyan-600 focus:ring-1 disabled:opacity-50 disabled:cursor-not-allowed shadow-none",
