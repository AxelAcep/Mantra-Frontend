...
interface ActivityLogSectionBastProps {
...
export default function ActivityLogSectionBast({
  logs,
}: ActivityLogSectionBastProps) {
  const grouped = logs.reduce<Record<string, ActivityLogItem[]>>((acc, log) => {
