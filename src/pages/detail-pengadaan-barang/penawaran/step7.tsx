          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
            <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:border-cyan-100 transition-all">
              <div className="flex items-center gap-2 mb-4 text-cyan-600">
                ...
                <p className="text-[10px] font-bold uppercase tracking-tight">No. Referensi</p>
              </div>
              <h3 className="text-xl font-bold text-slate-800">BAST-2402-011</h3>
            </div>

            <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:border-cyan-100 transition-all">
              <div className="flex items-center gap-2 mb-4 text-cyan-600">
                <Calendar size={16} strokeWidth={2.5} />
                <p className="text-[10px] font-bold uppercase tracking-tight">Tanggal Terbit</p>
              </div>
              <h3 className="text-xl font-bold text-slate-800">22 Februari 2026</h3>
            </div>

            <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:border-cyan-100 transition-all">
              <div className="flex items-center gap-2 mb-4 text-cyan-600">
                <Calendar size={16} strokeWidth={2.5} />
                <p className="text-[10px] font-bold uppercase tracking-tight">Tanggal Serah Terima</p>
              </div>
              <h3 className="text-xl font-bold text-slate-800">24 Februari 2026</h3>
            </div>
          </div>
        </div>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between bg-white rounded-xl border border-gray-100 p-4 hover:border-cyan-100 transition-all group">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold text-slate-800">Penyerahan BAST</p>
                      <p className="text-[10px] text-gray-400 mt-0.5 font-medium">Diunggah oleh Febri • 11 Feb, 09:00</p>
                    </div>
                  </div>
