  ...
  return (
      <div className="flex-1 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="p-4 flex items-center justify-between border-t border-gray-100 text-xs text-gray-500">
          <div>
            Menampilkan <span className="font-semibold text-gray-700">1</span> sampai <span className="font-semibold text-gray-700">6</span> dari <span className="font-semibold text-gray-700">48</span> perusahaan
          </div>
          <div className="flex items-center gap-2">
